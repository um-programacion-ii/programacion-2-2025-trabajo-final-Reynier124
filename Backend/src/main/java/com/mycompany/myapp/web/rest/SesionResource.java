...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Sesion}.
 */
@RestController
...
public class SesionResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<SesionDTO> createSesion(@RequestBody SesionDTO sesionDTO) throws URISyntaxException {
