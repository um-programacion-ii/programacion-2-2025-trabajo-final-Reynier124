...
public class VentaTestSamples {
    ...
    public static Venta getVentaSample1() {
        return new Venta().id(1L).ventaIdCatedra(1L).descripcion("descripcion1").cantidadAsientos(1).estado("estado1");
    }

    public static Venta getVentaSample2() {
        return new Venta().id(2L).ventaIdCatedra(2L).descripcion("descripcion2").cantidadAsientos(2).estado("estado2");
    }
