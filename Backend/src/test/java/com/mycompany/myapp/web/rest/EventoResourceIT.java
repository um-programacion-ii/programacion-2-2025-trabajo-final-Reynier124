...
class EventoResourceIT {
    ...
    private static final String DEFAULT_EVENTO_TIPO_NOMBRE = "AAAAAAAAAA";
    private static final String UPDATED_EVENTO_TIPO_NOMBRE = "BBBBBBBBBB";

    private static final String DEFAULT_EVENTO_TIPO_DESCRIPCION = "AAAAAAAAAA";
    private static final String UPDATED_EVENTO_TIPO_DESCRIPCION = "BBBBBBBBBB";
    ...
    public static Evento createEntity() {
        return new Evento()
            ...
            .eventoTipoNombre(DEFAULT_EVENTO_TIPO_NOMBRE)
            .eventoTipoDescripcion(DEFAULT_EVENTO_TIPO_DESCRIPCION)
    ...
    public static Evento createUpdatedEntity() {
        return new Evento()
            ...
            .eventoTipoDescripcion(UPDATED_EVENTO_TIPO_DESCRIPCION)
    ...
    void getAllEventos() throws Exception {
        ...
        restEventoMockMvc
            ...
            .andExpect(jsonPath("$.[*].eventoTipoNombre").value(hasItem(DEFAULT_EVENTO_TIPO_NOMBRE)))
            .andExpect(jsonPath("$.[*].eventoTipoDescripcion").value(hasItem(DEFAULT_EVENTO_TIPO_DESCRIPCION)))
    ...
    void getEvento() throws Exception {
        ...
        restEventoMockMvc
            ...
            .andExpect(jsonPath("$.eventoTipoNombre").value(DEFAULT_EVENTO_TIPO_NOMBRE))
            .andExpect(jsonPath("$.eventoTipoDescripcion").value(DEFAULT_EVENTO_TIPO_DESCRIPCION))
